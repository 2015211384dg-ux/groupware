...
// 프로젝트 관리
export const IconProject    = (p) => <Icon {...p} d={["M3 3h7v7H3z","M14 3h7v7h-7z","M14 14h7v7h-7z","M3 14h7v7H3z"]} />;
export const IconTask       = (p) => <Icon {...p} d={["M9 11l3 3L22 4","M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"]} />;
export const IconGantt      = (p) => <Icon {...p} d={["M3 5h8M3 10h14M3 15h11M3 20h6","M13 5h8M19 10h2M16 15h5M11 20h10"]} />;
export const IconUsers      = (p) => <Icon {...p} d={["M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2","M9 11a4 4 0 100-8 4 4 0 000 8z","M23 21v-2a4 4 0 00-3-3.87","M16 3.13a4 4 0 010 7.75"]} />;
export const IconFlag       = (p) => <Icon {...p} d={["M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z","M4 22v-7"]} />;
